          ...
          <div className="ed__side">
            <div className="ed__insight animate-slideInRight" id="knowledge-insight">
              ...
              <div style={{padding:16,display:'flex',flexDirection:'column',gap:16}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:8,paddingTop:8,borderTop:'1px solid var(--border-faintest)'}}><div style={{width:8,height:8,borderRadius:'50%',background:'var(--secondary-container)'}}/><span className="font-data-mono" style={{color:'var(--on-surface-variant)',fontSize:11}}>System confidence: 94%</span></div>
              </div>
            </div>
